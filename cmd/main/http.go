...
import (
	...
	imagessvr "angorasix.com/media/gen/http/images/server"
	staticsvr "angorasix.com/media/gen/http/static/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, imagesEndpoints *images.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	)
	{
		...
		imagesServer = imagessvr.New(imagesEndpoints, mux, dec, enc, eh, nil, media.ImagesUploadDecoderFunc)
	}
	// Configure the mux.
